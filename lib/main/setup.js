...
CT.dir.bir   = path.join('Applications', 'ClipTrigger.app', 'Contents', 'Resources', 'app', 'bin')
CT.dir.class = path.join(CT.dir.app, 'lib', 'main', 'classes')
CT.dir.img   = path.join(CT.dir.app, 'assets', 'img')
CT.dir.views = path.join(CT.dir.app, 'lib', 'views')
...
CT.RendererMonitor  = require(path.join(CT.dir.class, 'renderer_monitor' ))
