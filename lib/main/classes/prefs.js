module.exports = class {
  ...
  login_item_true() {
    log('BeepAdding to system login items')

    CT.electron.app.setLoginItemSettings({
      openAtLogin: true,
      path: '/Applications/ClipTrigger.app/Contents/Resources/app/bin',
      args: ['clip', '--hidden']
    })
  }
  ...
  login_item_false() {
    ...
    child_process.exec(`osascript -e 'tell application "System Events" to delete login item "ClipTrigger"'`)
  }
  ...
  open_win(win_to_open) {
    this.win.loadURL(url.format({
      pathname: CT.dir + 'lib/prefs/prefs.html',
      protocol: 'file:'
    }))
