module.exports = class {
  ...
  constructor() {
    this.icon_path = CT.dir + 'assets/img/icon.png'
    ...
    CT.electron.globalShortcut.register(
      'Control+Alt+Command+Return',
      () => new CT.InstantTrigger()
    )
  }
  ...
  notice(text = 'Notice!') {
    this.tray.setImage(CT.dir + 'assets/img/yellow.png')
  ...
  slow_reset(colour, text) {
    this.tray.setImage(CT.dir + `assets/img/${colour}.png`)
    this.tray.setTitle(` ${text}`)
